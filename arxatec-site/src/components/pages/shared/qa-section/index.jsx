      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40 w-full">
        <div className="mx-auto w-full">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="lg:text-base/7 text-sm font-semibold text-blue-600 text-left">
              {faqSection.tag}
            </h2>
            <p className="mt-2 max-w-lg text-pretty lg:text-4xl text-2xl font-semibold tracking-tight text-gray-950 text-left">
              {faqSection.title}
            </p>
            <p className="lg:mt-6 mt-2 max-w-2xl text-pretty text-left text-sm lg:text-base font-medium text-gray-600">
          ...
          <dl className="mt-2 divide-y divide-gray-900/10 w-full bg-white p-6 rounded-lg shadow-lg">
            {faqs.map((faq, index) => (
              <div key={index} className="py-6 first:pt-0 last:pb-0">
                ...
                >
                  <p className="md:text-base/7 text-sm">{faq.answer}</p>
                </dd>
              </div>
            ))}
          </dl>
