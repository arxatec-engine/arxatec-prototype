...
export const CalendarWeek = () => {
  ...
  return (
    <div
      className="flex overflow-hidden flex-col rounded-lg shadow-sm hover:shadow-md transition-all"
          ...
          >
            ...
            >
              <div className="grid grid-cols-7 text-sm/6 text-gray-500 sm:hidden">
                ...
                >
                  W{" "}
                  <span className="mt-1 flex size-8 items-center justify-center rounded-full bg-blue-600 font-semibold text-white">
                    12
                  </span>
                </button>
                <button
              ...
              <div className="-mr-px hidden grid-cols-7 divide-x divide-gray-100 border-r border-gray-100 text-sm/6 text-gray-500 sm:grid">
                ...
                <div className="flex items-center justify-center py-3">
                  <span className="flex items-baseline">
                    Wed{" "}
                    <span className="ml-1.5 flex size-8 items-center justify-center rounded-full bg-blue-600 font-semibold text-white">
                      12
                    </span>
                  </span>
                </div>
