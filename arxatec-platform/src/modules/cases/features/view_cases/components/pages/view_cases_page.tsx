...
export default function ViewCasesPage() {
  ...
  const navigateToExplorerCases = () => setLocation(APP_PATHS.EXPLORER_CASES);
  const navigateToMyCases = () => setLocation(APP_PATHS.PERSONAL_CASES);
  const navigateToClients = () => setLocation(APP_PATHS.CLIENTS);
  const navigateToCreateCase = () => setLocation(APP_PATHS.CREATE_CASE);
