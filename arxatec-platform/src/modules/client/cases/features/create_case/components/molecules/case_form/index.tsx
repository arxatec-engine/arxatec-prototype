      ...
      <div className="mt-4">
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <CustomToggle
              label="¿Es un caso privado?"
              description="Un caso privado es aquel que no es visible para otros abogados y para nadie solo para sera visible para el abogado que selecciones."
              initialState={value}
              onChange={onChange}
            />
          )}
      ...
      {isPrivate && (
        <div className="mt-4">
          ...
          <Controller
            name="lawyer"
            control={control}
            rules={{ required: "El abogado es requerido para casos privados" }}
            render={() => (
              <>
                {selectedUser ? (
                  <div
