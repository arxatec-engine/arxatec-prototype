...
const columns = [
  ...
  },
  {
    ...
    accessor: "status",
    align: "left" as const,
    renderCell: (value: CaseStatus) => (
      <div className="flex items-center gap-2">
        <div
          className={`size-3 rounded-sm flex items-center justify-center ${statusColors[value].bgColor}`}
        >
          <div className={`size-1.5 rounded-sm ${statusColors[value].color}`} />
        </div>
        <span className="text-sm text-gray-700">{statusLabels[value]}</span>
      </div>
    ),
  },
  {
...
const data = [
  ...
  },
  {
    ...
    status: "completado" as CaseStatus,
  },
  {
    id: "ARX-2025-003",
